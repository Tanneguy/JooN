...
public class TokensDigramsDialog extends JInternalFrame implements PropertyChangeListener
{
			...
			boolean isToken)
	{
		...
		getContentPane().setLayout(
				new MigLayout("insets 3", "[30::][30::][30::][30::][30::][30::][30::][30::][30::, grow]",
						"[20!, grow][grow][30!, grow]"));

		label = new JLabel("New label");
		getContentPane().add(label, "cell 0 0, span 9, alignx left,aligny top, height ::40");
		...
		getContentPane().add(scrollPane1, "cell 0 1, span 9, grow");
		...
		getContentPane().add(btnSelectAll, "cell 1 2");
		btnSelectAll.setActionCommand("SelectAll");

		btnFilter = new JButton("Filter");
		getContentPane().add(btnFilter, "cell 2 2");
		btnFilter.setActionCommand("Filter");

		btnExport = new JButton("Export");
		getContentPane().add(btnExport, "cell 3 2");
		...
		getContentPane().add(btnLocateR, "cell 4 2");
		...
		getContentPane().add(btnLocateG, "cell 5 2");
		...
		getContentPane().add(btnLocateP, "cell 6 2");
		...
		getContentPane().add(btnLocateB, "cell 7 2");
