...
public class TextLineNumber extends JPanel implements CaretListener, DocumentListener, PropertyChangeListener
{
	...
	// Text component this TextTextLineNumber component is in sync with (& labels to update)
	 ...
	 */
	public TextLineNumber(JTextComponent component, JLabel l, JLabel c)
	{
		this(component, 3);
		lblLineNo = l;
		lblColNo = c;
	...
	public void caretUpdate(CaretEvent e)
	{
		...
		try
		{
			...
			{
				offset = Utilities.getRowStart(component, offset) - 1;
				rowNum++;
			}
			lblLineNo.setText("Ln: " + rowNum);

			int offset = Utilities.getRowStart(component, caretPos);
			int colNum = caretPos - offset + 1;
			lblColNo.setText("Col: " + colNum);
		}
