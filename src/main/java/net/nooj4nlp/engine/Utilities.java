...
public class Utilities
{
	...
	private static final String PREFERENCES_NOJ_FILE_NAME = "Preferences." + Constants.JNOJ_EXTENSION;
	 ...
	 */
	private static void xcopy(String sourceDirPath, String targetDirPath, boolean onlyUnderlinedFiles)
			throws IOException
	{
