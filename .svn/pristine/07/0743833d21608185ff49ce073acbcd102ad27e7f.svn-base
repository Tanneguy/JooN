...
public class TextsActionListener implements ActionListener{

	private PreferencesDialog dialog = null;
	private JLabel label = null;
	
	public TextsActionListener(PreferencesDialog dialog, JLabel label){
		this.dialog = dialog;
		this.label = label;
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (result == JFontChooser.OK_OPTION){
			...
			dialog.setTFont(new Font(f.getName(), f.getStyle(), f.getSize()));
		}
	}
