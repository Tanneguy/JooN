...
{
	private static final long serialVersionUID = -2950771838225859664L;
	...
	protected class TextFieldFocusHandlerForTextSelection extends FocusAdapter
	{
		...
		private TextFieldFocusHandlerForTextSelection(JTextComponent textComponent)
		{
			this.textComponent = textComponent;
		}
	...
	protected class TextFieldKeyHandlerForListSelectionUpDown extends KeyAdapter
	{
		...
		private TextFieldKeyHandlerForListSelectionUpDown(JList list)
		{
	...
	protected class ListSearchTextFieldDocumentHandler implements DocumentListener
	{
		...
		private ListSearchTextFieldDocumentHandler(JList targetList)
		{
		...
		public class ListSelector implements Runnable
		{
			...
			private ListSelector(int index)
			{
				this.index = index;
			}
	...
	{
		private static final long serialVersionUID = 4647811173282824380L;
	...
	{
		private static final long serialVersionUID = -7696586874967777598L;
